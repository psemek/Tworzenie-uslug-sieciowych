/*
 * Utwórz przyk³adowe drzewko DOM bêd¹ce Twoj¹ wizytówk¹ (laboratorium 1) i zapisz je do pliku.
 */
...
public class drzewkoDOM {
	public static void main(String[] args) throws Exception, FileNotFoundException, TransformerException {
		...
		String sciezkaPliku = System.getProperty("user.dir") + "\\wizytowka.xml";
