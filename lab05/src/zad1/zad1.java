/*
 * Napisz serwet, który odczytuje dwa parametry prefix i suffix a nastêpnie generuje obrazek,
 * który zawiera tekst w postaci prefix@suffix. W przypadku, gdy nie ma któregoœ z parametrów,
 * wypisywany jest tekst nonami@noname.com.
 * Pomocne bêd¹ funkcja w Graphics2D drawString(String tekst, int x, int y);
 */
